...
namespace RVO
{
    ...
    internal class Agent
    {
        ...
        internal Agent(Simulator simulator)
        {
        ...
        internal void computeNeighbors()
        {
            ...
            _simulator.kdTree_.computeObstacleNeighbors(this, rangeSq);
            ...
            if (maxNeighbors_ > 0)
            {
                ...
                _simulator.kdTree_.computeAgentNeighbors(this, ref rangeSq);
            }
        }
        ...
        internal void computeNewVelocity()
        {
            ...
            for (int i = 0; i < agentNeighbors_.Count; ++i)
            {
                ...
                else
                {
                    ...
                    float invTimeStep = 1.0f / _simulator.timeStep_;
        ...
        internal void update()
        {
            ...
            position_ += velocity_ * _simulator.timeStep_;
        }
